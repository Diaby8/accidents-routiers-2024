...
"**Source :** dictionnaire de donnees officiel BAAC (Bulletin d'Analyse des Accidents Corporels), "
"publie par l'ONISR sur data.gouv.fr aux cotes des fichiers CSV "
"(rubrique *Description des bases de donnees annuelles*). "
"Liste non exhaustive ci-dessous : quelques colonnes cles par table pour montrer la comprehension "
"du schema, le detail complet des codes est dans le dictionnaire cite en source.\n\n"
...
"Les 3 339 accidents hors bornes metropolitaines correspondent aux territoires d'outre-mer. "
"Ce ne sont pas des erreurs. Nous les avons mis de cote pour limiter l'analyse a la France "
